...
\url{http://fanfiction.net/s/10360716/1/The-Metropolitan-Man}
\end{center}
\clearpage
...
\noindent Typesetting project inspired by Mike Schw\"orer's project:
...
The following two pages show the code that produced this PDF. By running it in your terminal, the code will
...
and print your own favorite works of online literature! (Compensating the authors of course!)
...
as an \texttt{<h1>} header tag, because pandoc --- used later --- converts header tags to \LaTeX\ chapters. 
...
history of the city. There should be men in collars somewhere around
\ldots{} there.''
...
you, he just said because he was having a bad day. Maybe he just
\ldots{} needed someone to talk to, and talking to you made whatever
difficulties he was having easier to bear.''
...
\emph{As always, I appreciate the
favorites/follows/reviews/recommendations. A special thanks to my wife
Alyssa for being my beta reader.}
